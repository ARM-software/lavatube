...
def save_add_tracking(name):
	...
	if name == 'vkCmdDrawMultiIndexedEXT':
		...
		z.loop_end()
	elif name in vk.cmd_renderpass_commands:
		z.do('commandbuffer_data->renderpass_count++;')
	elif name in spec.pipeline_execute_commands:
...
def load_add_pre(name):
	...
	elif name in vk.cmd_scoped_begin_commands:
		z.do('commandbuffer_data.nesting++;')
	elif name in vk.cmd_scoped_end_commands:
