...
ignore_on_read = [ 'vkGetMemoryHostPointerPropertiesEXT', 'vkCreateDebugUtilsMessengerEXT', 'vkDestroyDebugUtilsMessengerEXT', 'vkAllocateMemory',
	...
	'vkGetDescriptorEXT', 'vkGetPhysicalDeviceVideoCapabilitiesKHR', 'vkGetPhysicalDeviceImageFormatProperties2',
	'vkGetPhysicalDeviceImageFormatProperties2KHR', 'vkGetDeviceBufferMemoryRequirements', 'vkGetDeviceBufferMemoryRequirementsKHR',
...
trace_post_calls = [ 'vkCreateInstance', 'vkCreateDevice', 'vkDestroyInstance', 'vkGetPhysicalDeviceFeatures', 'vkGetPhysicalDeviceProperties',
		...
		'vkCmdBuildAccelerationStructuresKHR', 'vkCmdBuildAccelerationStructuresIndirectKHR', 'vkCmdTraceRaysKHR', 'vkCmdTraceRaysIndirectKHR', 'vkCmdTraceRaysIndirect2KHR', 'vkBindBufferMemory2KHR', 'vkCmdPushDescriptorSet2KHR', 'vkCmdPushDescriptorSet2', 'vkCmdPushDescriptorSetWithTemplate',
		...
		'vkGetBufferMemoryRequirements', 'vkGetBufferMemoryRequirements2', 'vkGetImageMemoryRequirements2', 'vkGetImageMemoryRequirements2KHR', 'vkGetPhysicalDeviceMemoryProperties',
