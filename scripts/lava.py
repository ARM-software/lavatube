...
out(targets_read_headers, '#define SPV_ENABLE_UTILITY_CODE 1')
out(targets_read_headers, '#include <spirv/unified1/spirv.h>')
out(targets_read_headers, '#include "spirv-simulator/spirv_simulator.hpp"')
