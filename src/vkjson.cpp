...
bool readVkPhysicalDeviceLimits(const Json::Value& root, VkPhysicalDeviceLimits& in)
{
	...
	in.framebufferColorSampleCounts = static_cast<VkSampleCountFlags>(root["framebufferColorSampleCounts"].asUInt());
	in.framebufferDepthSampleCounts = static_cast<VkSampleCountFlags>(root["framebufferDepthSampleCounts"].asUInt());
	in.framebufferStencilSampleCounts = static_cast<VkSampleCountFlags>(root["framebufferStencilSampleCounts"].asUInt());
	in.framebufferNoAttachmentsSampleCounts = static_cast<VkSampleCountFlags>(root["framebufferNoAttachmentsSampleCounts"].asUInt());
	in.maxColorAttachments = (uint32_t)root["maxColorAttachments"].asInt64();
	in.sampledImageColorSampleCounts = static_cast<VkSampleCountFlags>(root["sampledImageColorSampleCounts"].asUInt());
	in.sampledImageIntegerSampleCounts = static_cast<VkSampleCountFlags>(root["sampledImageIntegerSampleCounts"].asUInt());
	in.sampledImageDepthSampleCounts = static_cast<VkSampleCountFlags>(root["sampledImageDepthSampleCounts"].asUInt());
	in.sampledImageStencilSampleCounts = static_cast<VkSampleCountFlags>(root["sampledImageStencilSampleCounts"].asUInt());
	in.storageImageSampleCounts = static_cast<VkSampleCountFlags>(root["storageImageSampleCounts"].asUInt());
